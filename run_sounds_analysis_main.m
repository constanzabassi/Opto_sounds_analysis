...
wrapper_avg_pooled_type_traces(context_data.dff,pooled_cell_types,[1:24],savepath,'sound_dff_functional_types_-2to0_',plot_info,[1:10], plot_info.celltype_names,);
