function [sound_trials_stim, sound_trials_ctrl, ...
    ...
    find_condition_trials_single(stim_trials, ctrl_trials, current_conditions, current_conditions_ctrl)
% find_condition_trials_single selects and balances sound trials for a single mouse and context.
%
%   Inputs:
...
%          find_sound_trials_single(stim_trials, ctrl_trials, current_conditions, current_conditions_ctrl);
    ...
    if ~isempty(current_conditions)
        ...
        sound_right_trials = stim_trials(current_conditions == 0);
        % Find left/right trials for control.
        sound_left_trials_ctrl = ctrl_trials(current_conditions_ctrl == 1);
        sound_right_trials_ctrl = ctrl_trials(current_conditions_ctrl == 0);
