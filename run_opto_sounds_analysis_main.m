...
% table_2 = struct2table_recursive(unwrap_cells_in_struct(evoked_stats_diff),'',{'bootstat'});
% 
...
table_fig3_evoked = make_stats_tables_evoked(traces_mean, traces_mean2, '\sig_neurons\', {'PYR', 'SOM', 'PV'},63:92, mod_params.savepath);
