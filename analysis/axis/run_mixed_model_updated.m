...
save_dir = 'V:\Connie\results\opto_sound_2025\context\axis_lme_plots_updated\dff';
...
for celltype = 1:3
    ...
    plot_me_regression_lines(lme_stim,tbl_stim,context_all_stim,'Stim Projection',save_dir_celltype);
