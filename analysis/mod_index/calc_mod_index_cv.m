...
% Constants
VALID_MOD_TYPES = {'ctrl', 'influence', 'prepost', 'prepost_sound','prepost_ctrl','prepost_sound','prepost_num','ctrl_num','prepost_ctrl_abs','prepost_abs','ctrl_abs','signed_ctrl','prepost_sound_num','pre_engagement'};
